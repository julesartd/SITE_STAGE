...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 28 juin 2022 à 11:43
...
CREATE TABLE IF NOT EXISTS `activite` (
  ...
  `nomActivite` varchar(1100) NOT NULL,
  `idProfesseur` int(11) NOT NULL,
  `idClasse` int(11) NOT NULL,
  PRIMARY KEY (`idActivite`),
  KEY `FK_PROF45` (`idProfesseur`),
  KEY `FK_CLASSE45` (`idClasse`)
...
(4, 'test', 18, 50),
(5, ':)', 18, 50),
(6, 'Outil décapsuleur', 18, 50),
(7, 'Moule médaille', 18, 50),
(8, 'test', 18, 50);
...
CREATE TABLE IF NOT EXISTS `attribuer_activite` (
  ...
  `idWeekDebut` int(11) NOT NULL,
  `idWeekFin` int(11) NOT NULL,
  PRIMARY KEY (`idActivite`,`idSousCompetence`,`idWeekDebut`,`idWeekFin`),
  KEY `FK_WEEKDEBUT` (`idWeekDebut`),
  KEY `FK_WEEKFIN` (`idWeekFin`),
  KEY `FK_SC` (`idSousCompetence`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `attribuer_activite_matiere`
--

DROP TABLE IF EXISTS `attribuer_activite_matiere`;
CREATE TABLE IF NOT EXISTS `attribuer_activite_matiere` (
  `idActivite` int(11) NOT NULL,
  `idCompetenceMatiere` int(11) NOT NULL,
  `idWeekDebut` int(11) NOT NULL,
  `idWeekFin` int(11) NOT NULL,
  PRIMARY KEY (`idActivite`,`idCompetenceMatiere`,`idWeekDebut`,`idWeekFin`),
  KEY `FK_MatiereComp10` (`idCompetenceMatiere`),
  KEY `FK_WeekDeb10` (`idWeekDebut`),
...
(32, 'C1', 'Rechercher les informations', 3),
(33, 'C2', 'Formuler et transmettre les informations', 3),
(34, 'C3', 'S\'impliquer dans un environnement professionnel', 3),
(35, 'C4', 'Interpreter et verifier les données de définition d\'un outillage', 3),
(36, 'C5', 'Preparer la réalisation d\'un outillage', 3),
(37, 'C6', 'Configuer et refler les moyens de productions', 3),
(38, 'C7', 'Mettre en œuvre les moyens de production', 3),
(39, 'C8', 'Exploiter un planning', 3),
(40, 'C9', 'Assembler les élements d\'un outillage', 3),
(41, 'C10', 'Controler et suivre une production', 3),
(42, 'C11', 'Effectuer la maintenance des outillages et des moyens de production', 3),
(43, 'C12', 'Appliquer les procedures liees à la qualite et sécurité', 3);
...
(1, 'Administrateur'),
(2, 'Professeur d\'enseignement professionnel'),
(3, 'Professeur d\'enseignement général');
...
CREATE TABLE IF NOT EXISTS `matiere` (
  ...
  `nomMatiere` varchar(20000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `matiere_competence` (
  `idCompetenceMatiere` int(11) NOT NULL AUTO_INCREMENT,
  `libelleCompetenceMatiere` varchar(20000) NOT NULL,
  `intitulerCompetenceMatiere` varchar(20000) NOT NULL,
  `idMatiere` int(11) NOT NULL,
  PRIMARY KEY (`idCompetenceMatiere`)
...
INSERT INTO `matiere_competence` (`idCompetenceMatiere`, `libelleCompetenceMatiere`, `intitulerCompetenceMatiere`, `idMatiere`) VALUES
(3, 'C2', 'savoir lire', 1),
(5, 'C1', 'Se localiser', 6);
...
(50, 1, 'Mettre en œuvre une démarche de recherche', 32),
(51, 2, 'Classer hierarchiser les informations', 32),
(52, 1, 'Identifier les informations à transmettre', 33),
(53, 2, 'Choisir et utilser les outils de communication en Présen ou distan', 33),
(54, 3, 'Structurer la communication', 33),
(55, 4, 'Adapter la communication', 33),
(56, 5, 'Rédiger un rapport une note', 33),
(57, 6, 'Presenter oralement un rapport une note un compte rendu', 33),
(58, 1, 'Créer et maintenir un espace collaboratif', 34),
(59, 2, 'Installer un climat relationnel adapté à la demande', 34),
(60, 3, 'Veiller au caractère opérationnel et fonctionnel des espaces et des postes de travail', 34),
(61, 4, 'Assurer le suivi des contrats et des abonnements', 34),
(62, 5, 'Mettre à jour un état budgétaire et signaler les écarts', 34),
(63, 1, 'Localiser et identifier les sous ensembles', 35),
(64, 2, 'Analyser les solutions constructives', 35),
(65, 3, 'Exploiter le modele numérique', 35),
(66, 4, 'Proposer un modele numérique d\'une modification du modèle de  définition', 35),
(67, 5, 'Vérifier les caracteristiques d\'un outillage', 35),
(68, 6, 'Actualiser une base de données clients', 35),
(69, 1, 'Etablir une chronologie des opération de réalisation', 36),
(70, 2, 'Définir un montage d\'usinage et les referentiels associés', 36),
(71, 3, 'Définir les opération de réalisation  d\'un élément', 36),
(72, 4, 'Choisir les outils et les parametres associés', 36),
(73, 5, 'Définir le contrôle  outil par programmation', 36),
(74, 6, 'Etablir le programme en FAO', 36),
(75, 7, 'Etablir un mode opératoire de contrôle', 36),
(76, 8, 'Génerer les documents de réalisation', 36),
(77, 1, 'Organiser et préparer son poste de travail', 37),
(78, 2, ' Installer les outils et entrer les paramètres', 37),
(79, 3, 'Régler les moyens de production', 37),
(80, 4, 'Vérifier et valider les réglages', 37),
(81, 1, 'Conduire la production', 38),
(82, 2, 'Réaliser les opérations de fabrication', 38),
(83, 3, 'Effectuer les retouches necessaires', 38),
(84, 1, 'Identifier sur un planning  les activités', 39),
(85, 2, 'Situer sur un planning la duréee et le chronologie des taches', 39),
(86, 3, 'Identier les priorités de fabrication', 39),
(87, 4, 'Localiser et identifier les défaillances', 39),
(88, 5, 'Mettre en œuvre les consignes données', 39),
(89, 1, 'Préparer les activités d\'assemblage', 40),
(90, 2, 'Assembler les élements', 40),
(91, 3, 'Mettre en œuvre des actions à destination du personnel', 40),
(92, 4, 'Choisir les moyens de manutention adaptés', 40),
(93, 5, 'Effectuer les corrections si necessaire', 40),
(94, 1, 'Choisir les moyens de controles', 41),
(95, 2, 'Configurer les moyens de controles', 41),
(96, 3, 'Appliquer une procdure de mesurage et contrôle', 41),
(97, 4, 'Vérifier la conformité de l\'outillage', 41),
(98, 5, 'Exploiter les resultats des controles et decider des actions à mener', 41),
(99, 1, 'Tenir à jour le dossier de maintenance des machines', 42),
(100, 2, 'Verifier l\'etat de fonctionnment et de conformité des outillages et machines', 42),
(101, 3, 'Consigner les resultats liés à la maintenance de l\'outillage', 42),
(102, 4, 'Effectuer la maintenance des outillages', 42),
(103, 5, 'Signaler les dysfonctionnments constatés machine et ou outillage', 42),
(104, 1, 'Participer à l\'amélioration qualité continue de l\'entreprise', 43),
(105, 2, ' Aménager son poste de travail', 43),
(106, 3, 'Appliquer les consignes de sécurités', 43),
(107, 4, 'Gerer les dechets pour proteger l\'environnement', 43);
...
ALTER TABLE `activite`
  ADD CONSTRAINT `FK_CLASSE45` FOREIGN KEY (`idClasse`) REFERENCES `classe` (`idClasse`),
  ADD CONSTRAINT `FK_PROF45` FOREIGN KEY (`idProfesseur`) REFERENCES `professeur` (`idProf`);
...
--
-- Contraintes pour la table `attribuer_activite_matiere`
--
ALTER TABLE `attribuer_activite_matiere`
  ADD CONSTRAINT `FK_Activite10` FOREIGN KEY (`idActivite`) REFERENCES `activite` (`idActivite`),
  ADD CONSTRAINT `FK_MatiereComp10` FOREIGN KEY (`idCompetenceMatiere`) REFERENCES `matiere_competence` (`idCompetenceMatiere`),
  ADD CONSTRAINT `FK_WeekDeb10` FOREIGN KEY (`idWeekDebut`) REFERENCES `time_dimension` (`week`),
  ADD CONSTRAINT `FK_WeekFin10` FOREIGN KEY (`idWeekFin`) REFERENCES `time_dimension` (`week`);
